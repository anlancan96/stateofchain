...
var abiWarranty = [{"constant":true,"inputs":[],"name":"convention","outputs":[{"name":"expireTime","type":"uint64"},{"name":"idProduct","type":"uint64"},{"name":"compensation","type":"uint256"},{"name":"status","type":"uint256"},{"name":"employer","type":"address"},{"name":"buyer","type":"address"},{"name":"hash","type":"bytes32"},{"name":"signatureEmployer","type":"bytes"},{"name":"signatureBuyer","type":"bytes"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"_owner","type":"address"},{"name":"_hash","type":"bytes32"},{"name":"r","type":"bytes32"},{"name":"s","type":"bytes32"},{"name":"v","type":"uint8"}],"name":"verifyWarranty","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"pure","type":"function"},{"constant":true,"inputs":[],"name":"benefit","outputs":[{"name":"sender","type":"address"},{"name":"receiver","type":"address"},{"name":"balance","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"_owner","type":"address"}],"name":"demonstrateMeInvalid","outputs":[{"name":"","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_productsContract","type":"address"}],"name":"courts","outputs":[{"name":"","type":"string"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_buyer","type":"address"},{"name":"_signatureEmployer","type":"bytes"},{"name":"_hash","type":"bytes32"}],"name":"createParnter","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_signatureBuyer","type":"bytes"}],"name":"purchase","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_status","type":"uint256"}],"name":"updateState","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"getBenefit","outputs":[{"components":[{"name":"sender","type":"address"},{"name":"receiver","type":"address"},{"name":"balance","type":"uint256"}],"name":"","type":"tuple"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_signatureEmployer","type":"bytes"},{"name":"_hash","type":"bytes32"}],"name":"sell","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"inputs":[{"name":"_expireTime","type":"uint64"},{"name":"_compensation","type":"uint256"},{"name":"_idProduct","type":"uint64"}],"payable":false,"stateMutability":"nonpayable","type":"constructor"}]



var addressContractMaster = '0xcaab445fcb3aacbf8619040217afb0ee09b01fe5'
