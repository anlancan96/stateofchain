...
contract Warranty is Owner {
    ...
    address private addressMaster = 0xcaab445fcb3aacbf8619040217afb0ee09b01fe5;
    ...
    function createParnter(address _buyer, bytes _signatureEmployer, bytes32 _hash) external onlyAdmin {
    ...
    function updateState(uint _status) external onlyOwner(convention.buyer) {
        convention.status = _status;
    }
